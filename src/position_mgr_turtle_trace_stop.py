...
class PositionMgrTurtleTraceStop(PositionMgr):
    stop_atr_factor = 2
    # df_i = None
    ...
    def __init__(self, account_risk=0.01, stop_atr_factor=10, max_buy_cnt=4 ):
        super(PositionMgrTurtleTraceStop, self).__init__()
